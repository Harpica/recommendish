...
// type MessageRequest = InitRequest | CommentRequest;
...
//         const data = JSON.parse(message.toString()) as MessageRequest;
//         switch (data.type) {
//             case 'init':
//                 this.initClient(data, client);
//                 break;
//             case 'comment':
//                 this.handleComment(data, client);
//                 break;
...
//         }
//     }
//     private initClient(message: InitRequest, sender: WebSocket) {
...
//     private handleComment(message: CommentRequest, sender: WebSocket) {
